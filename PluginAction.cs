...
namespace Trovo
{
	[PluginActionId("me.cupara.trovo")]
	public class PluginAction : PluginBase
	{
		...
		public PluginAction(ISDConnection connection, InitialPayload payload) : base(connection, payload)
		{
			...
			{
				this.settings = paylaod.Settings.ToObject<PluginSettings>();
			}
		...
		private void Connection_OnTitleParametersDidChange(object sender, BarRaider.SdTools.Wrappers.SDEventReceiveEventArgs<BarRaider.SdTools.Events.TitleParametersDidChange> e)
		{
		}
